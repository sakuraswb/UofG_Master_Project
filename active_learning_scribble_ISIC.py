...
def active_learning_loop_scribble_ISIC(
    ...
    rounds=5,
    query_size=30,
    save_dir="D:/project/CODE/scribble_models_ISIC/",
    ...
    for round in range(rounds):
        ...
        if round == 0:
            if os.path.exists(initial_model_path):
                ...
                train_gen_init = ISICDataset(batch_size, img_size, initial_labeled_images, initial_labeled_masks)
                train_model_ISIC(model, train_gen_init, train_gen_init, save_path=initial_model_path)
        ...
        for p in selected_paths:
            ...
            if not os.path.exists(dst):
                shutil.copy(p, dst)
        input("when finished scribble，press Enter to continue...")
        ...
        display_sample_ISIC(
            ...
            base_save_dir="D:/project/CODE/predicted_image_scribble_ISIC/"
        )
